...
{
	echo get_reservation_reminders($conn);
}
...
?>
		...
		<div id="users_div"><?php echo list_users($conn); ?></div>
		...
		<input type="text" id="price_input" value=""> <label for="price_input">Price per reservation, in <?php echo global_currency; ?></label><br><br>
...
?>
	...
	<div id="usage_div"><?php echo get_usage($conn); ?></div>
