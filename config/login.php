...
if(isset($_GET['login']))
{
	...
	echo login($user_email, $user_password, $user_remember,$conn);
}
...
elseif(isset($_GET['create_user']))
{
	...
	echo create_user($user_name, $user_email, $user_password, $user_secret_code,$conn);
}
...
<br><br><br><br>
	...
	<form action="." id="login_form" autocomplete="on"><p>
