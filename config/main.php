...
// MySQL
// 'localhost', 'root', '', 'phpmyreservation'

//mysql_select_db('phpmyreservation')or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
define('global_price', get_configuration('price', $conn));

// Date
 date_default_timezone_set("Europe/Zagreb");
define('global_year', date('Y'));
define('global_week_number', date('Y-m-d'),'0');
